...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    require_once(dirname(__FILE__).'/html2pdf_classes/exception.class.php');
    require_once(dirname(__FILE__).'/html2pdf_classes/locale.class.php');
    require_once(dirname(__FILE__).'/html2pdf_classes/myPdf.class.php');
    require_once(dirname(__FILE__).'/html2pdf_classes/parsingHtml.class.php');
    require_once(dirname(__FILE__).'/html2pdf_classes/parsingCss.class.php');
